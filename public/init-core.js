// init-core.js - Núcleo del Editor Corregido
console.log('🚀 Inicializando Editor Pro+ Premium...');

// ==================== MANAGERS BÁSICOS CORREGIDOS ====================
...
class EditorApp {
    ...
    duplicateSelected() {
        if (this.selectedElement) {
            ...
            duplicate.id = `${duplicate.type}_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
            duplicate.x += 20;
            duplicate.y += 20;
